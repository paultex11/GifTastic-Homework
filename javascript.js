var topics = 	["Cat", "Dog", "Shark", "Elephant", "Dolphins", 
				"Eagle", "Spider", "Frog", "Snake", "Lizard"];
...
$(document).on("click", ".topic-button", function() {
	$("#Animal-gif").empty(); //empties out previous gifs

	var apiKey = "XFqY9urwR11rC2Hz0TyWOJiS76oJu9Gc";
